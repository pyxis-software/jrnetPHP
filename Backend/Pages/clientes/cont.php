        ...
        <?php if (!isset($CORE->url[1])) { ?>
            ...
            <div class="row">
                <div class="col s12 m8">
                    ...
                    <br />
                    <strong>Telefones para contato: <br /><?php
                        if ($cliente->getCelPrincipal() != "")
                            echo $cliente->getCelPrincipal() . ' |';
                        if ($cliente->getCelSecundario() != "")
                            echo ' ' . $cliente->getCelSecundario()
                            ?></strong>
                </div>
                <div class="col s12 m4 pt4">
                    <?php
                    ...
                    <br />
                    <br />
                    <a class="waves-effect red darken-1 btn modal-trigger" href="#modalConfirma" id="btnDisableCliente">Desativar</a>
                    <br />
                    <br />
                    <?php } ?>
                </div>
    ...
    if ($cliente->getAtivo() == 1) {
        ...
        <?php $CORE->functions->getFaturas($cliente->getId()) ?>
                ...
                <div id="modalConfirma" class="modal">
                    <div class="modal-content">
                        <b id="tipoConfirm" lang=""></b>
                        <h5 id="textConfirm"></h5>
                        <b id="idClienteConfirm" lang="<?php echo $cliente->getId() ?>"></b>
                    </div>
                    <div class="modal-footer">
                        <a href="javascript:void(0)" class="waves-effect waves-light btn green accent-4" id="btnConfirmaAction">Confirmar</a>
                        <a href="javascript:void(0)" class="modal-close waves-effect waves-light btn">Cancelar</a>
                    </div>
                </div>
